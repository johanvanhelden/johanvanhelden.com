<section id="about-me" class="py-10 {{ $class ?? ''}}">
    <div class="max-w-3xl mx-auto px-6">
        ...
        <p class="mb-4">
            After finishing high school I knew that I wanted to make my living by programming. So I choose an
            "Application Development" study. When I completed my internship, I started working full-time making
            websites and web applications. The language I was writing in at the time was
            <a
        ...
        <p class="mb-4">
            ASP Classic; however, was quickly overshadowed by PHP and I decided to switch to that programming
            language instead. In the beginning I was making my own "mini frameworks" for projects I was working on,
        ...
        <p class="mb-4">
            Luckily, after a few months, I discovered a framework called
            <a
